      ...
      <div className="w-full mx-auto max-w-[2000px] px-0 sm:px-2 md:px-4 lg:px-6">
        <div className="p-3 sm:p-4 md:p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 md:gap-6 mt-6 sm:mt-8">
            <div className={`rounded-lg p-4 sm:p-5 space-y-3 sm:space-y-4 transition-all duration-300 ${
              theme === 'dark' 
                ? 'bg-gray-800/90 border border-gray-700/50 hover:bg-gray-800/70' 
                : 'bg-white border border-gray-100 shadow-sm hover:shadow-md hover:bg-[radial-gradient(at_40%_20%,hsl(250,91%,99%)_0px,transparent_50%),radial-gradient(at_80%_0%,hsl(340,82%,99%)_0px,transparent_50%),radial-gradient(at_0%_50%,hsl(160,84%,99%)_0px,transparent_50%)] bg-white'
            }`}>
            ...
            <div className={`rounded-lg p-4 sm:p-5 space-y-3 sm:space-y-4 transition-all duration-300 ${
              ...
              <div className="flex items-center justify-between">
                <span className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Integrations</span>
              ...
              <div>
                <p className={`mb-2 text-sm font-medium ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>HTML Code</p>
                <div className={`flex items-center justify-between px-3 py-2 rounded-md text-[10px] xs:text-xs font-mono overflow-hidden ${
                  theme === 'dark' 
              ...
              <p className={`text-[11px] xs:text-xs rounded-md p-2 sm:p-3 ${
                theme === 'dark' 
