...
const SideNav = () => {
  ...
  const handleNavClick = async (e, item) => {
    ...
    { name: 'Posts', icon: Share2, path: '/dashboard/social-sharing', active: location.pathname === '/dashboard/social-sharing' },
    { name: 'Auto Posting', icon: Share2, path: '/dashboard/schedule-post', active: location.pathname === '/dashboard/schedule-post' },
