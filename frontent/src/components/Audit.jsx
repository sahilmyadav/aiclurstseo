...
const Audit = () => {
  ...
  const reviewTrend = useMemo(() => {
    ...
    const currentPeriod = reviews.filter((r) => new Date(r.createTime) > thirtyDaysAgo).length;
  ...
  const ratingTrend = useMemo(() => {
    ...
    const currentAvg =
      currentReviews.length > 0
        ? currentReviews.reduce((sum, r) => sum + (ratingMap[r.starRating] || 0), 0) /
          currentReviews.length
        : 0;

    const previousAvg =
      previousReviews.length > 0
        ? previousReviews.reduce((sum, r) => sum + (ratingMap[r.starRating] || 0), 0) /
    ...
    return {
      ...
      previous: previousAvg.toFixed(1),
          ...
          <div className="pb-4 space-y-4">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className={`text-sm mt-1 ${theme === 'dark' ? 'text-white/60' : 'text-gray-600'}`}>
                Real-time performance insights and review analytics
              </p>
            </div>
            ...
            {selectedBusiness && (
              <div
                className={`rounded-lg p-3 transition-all duration-300 hover:-translate-y-0.5 ${
                  theme === 'dark'
              ...
              >
                <div className="flex items-center justify-center sm:justify-start space-x-2">
                  ...
                  <span
                    className={`text-sm text-center sm:text-left ${theme === 'dark' ? 'text-white/70' : 'text-green-800'}`}
                  >
                    <span className={theme === 'dark' ? 'text-white/50' : 'text-green-600'}>
                      Analyzing:
                    </span>
                    <span className="font-semibold block sm:inline mt-1 sm:mt-0 sm:ml-1">
              ...
              {!isConnected ? (
                <div className="flex items-center justify-center h-full">
                  <div className="text-center space-y-4">
                    ...
                    <p
                      className={`max-w-md ${theme === 'dark' ? 'text-white/60' : 'text-gray-600'}`}
                    >
                      Connect your Google Business Profile to access performance insights and
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div className="custom-datepicker">
                                <DatePicker
                                  ...
                                  maxDate={new Date()}
                                  className={`rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 ${
                                    theme === 'dark'
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                              ...
                              >
                                ...
                                <div className="flex items-center text-xs mt-1">
                                  ...
                                  <span
                                    className={`ml-1 ${theme === 'dark' ? 'text-white/60' : 'text-gray-600'}`}
                                  >
                                    vs last 30 days
                                  </span>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              ...
                              >
                                <h3
                                  className={`text-lg font-semibold mb-4 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
                                >
                                  Monthly Review Trend ({new Date().getFullYear()})
                                </h3>
                                ...
                                monthlyData.some((d) => d.reviews > 0) ? (
                                  <ResponsiveContainer width="100%" height={200}>
                                    <BarChart data={monthlyData}>
                                      <CartesianGrid
                                        strokeDasharray="3 3"
                                        stroke={theme === 'dark' ? '#3b3b5a' : '#e5e7eb'}
                                      />
                                      <XAxis
                                        dataKey="month"
                                        stroke={theme === 'dark' ? '#b9b9d2' : '#6b7280'}
                                        fontSize={12}
                                      />
                                      <YAxis
                                        stroke={theme === 'dark' ? '#b9b9d2' : '#6b7280'}
                                  ...
                                  <div
                                    className={`h-[200px] flex items-center justify-center text-sm ${theme === 'dark' ? 'text-white/40' : 'text-gray-400'}`}
                                  >
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                  ...
                                  <div>
                                    <div
                                      className={`text-sm ${theme === 'dark' ? 'text-white/60' : 'text-green-800'}`}
                                    >
                                      Selected Profile
                                    </div>
                                    <div
                                    ...
                                    <div
                                      className={`text-xs ${theme === 'dark' ? 'text-white/60' : 'text-green-700'}`}
                                    >
                        ...
                        {reviews && reviews.length > 0 ? (
                          <>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                              ...
                              >
                                <div
                                  className={`text-sm mb-2 ${theme === 'dark' ? 'text-white/60' : 'text-gray-600'}`}
                                >
                                  Current Period
                                </div>
                                <div className="text-2xl font-bold text-green-400">
                              ...
                              >
                                ...
                                <div
                                  className={`text-2xl font-bold ${reviewTrend.change >= 0 ? 'text-green-400' : 'text-red-400'}`}
                                >
                                  {reviewTrend.change >= 0 ? '+' : ''}
                                  {reviewTrend.change}%
                                </div>
                            ...
                            >
                              ...
                              <div className="space-y-3">
                                {reviewStats?.ratings?.length > 0 ? (
                                  reviewStats.ratings
                                    ...
                                    .map((item) => (
                                      <div key={item.rating} className="flex items-center gap-3">
                                        ...
                                        <div
                                          className={`flex-1 h-3 rounded-full overflow-hidden ${theme === 'dark' ? 'bg-white/10' : 'bg-gray-200'}`}
                                        >
                                          <div
                                        ...
                                        <span
                                          className={`w-16 text-sm text-right ${theme === 'dark' ? 'text-white/70' : 'text-gray-700'}`}
                                        >
                                          {item.count} (
                                          {reviewStats.totalReviews > 0
                                            ? (
                                  ...
                                  <div
                                    className={`text-center py-4 ${theme === 'dark' ? 'text-white/60' : 'text-gray-600'}`}
                                  >
                                    {loading
                                      ? 'Loading rating data...'
                              ...
                              <h3
                                className={`text-sm font-semibold mb-4 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
                              >
                                Performance Summary
                              </h3>
                              <div className="space-y-3">
                                ...
                                <div className="flex justify-between items-center">
                                  ...
                                  <span className="font-semibold">
                                    {reviewStats?.recentReviews?.length || 0} reviews
                                  </span>
                                </div>
                                <div className="flex justify-between items-center">
                                  <span
                          ...
                          <div className="flex items-center justify-center h-64">
                            <div className="text-center space-y-4">
                              ...
                              <p
                                className={`max-w-md ${theme === 'dark' ? 'text-white/60' : 'text-gray-600'}`}
                              >
                                No reviews available yet. Performance metrics will appear once you
                      ...
                      <div className="space-y-6 pb-8">
                        {!aiInsights ? (
                          <div className="text-center py-8">
                            ...
                            <p
                              className={`max-w-2xl mx-auto mb-6 ${theme === 'dark' ? 'text-white/60' : 'text-gray-600'}`}
                            >
                              Generate comprehensive AI analysis of your reviews including
                              strengths, weaknesses, and actionable recommendations.
                            </p>

                            {insightsError && (
                              <div
                                className={`mb-4 p-4 rounded-lg text-sm transition-all duration-300 ${
                                  theme === 'dark'
                            ...
                            {!reviews?.length && (
                              <p className="text-red-400 text-sm mt-4">
                                Need at least 1 review to generate insights
                              </p>
                            )}
                          </div>
                        ) : (
                          <div className="space-y-6">
                            ...
                            <div
                              className={`rounded-lg p-6 transition-all duration-300 hover:-translate-y-0.5 ${
                                theme === 'dark'
                                  ? 'bg-[#1a1b2e]/90 border border-white/10 hover:bg-[#1a1b2e]'
                                  : 'bg-white border border-gray-200 shadow-sm hover:shadow-md hover:bg-[radial-gradient(at_40%_20%,hsl(250,91%,99%)_0px,transparent_50%),radial-gradient(at_80%_0%,hsl(340,82%,99%)_0px,transparent_50%),radial-gradient(at_0%_50%,hsl(160,84%,99%)_0px,transparent_50%),white]'
                              }`}
                            ...
                            {aiInsights.summary && (
                              ...
                              >
                                ...
                                <p
                                  className={`leading-relaxed ${theme === 'dark' ? 'text-white/80' : 'text-gray-800'}`}
                                >
                                  {aiInsights.summary}
                                </p>
                              </div>
                            ...
                            {aiInsights.sentimentAnalysis && (
                              ...
                              >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                  ...
                                  >
                                    <div className="text-2xl font-bold text-yellow-400">
                                      {aiInsights.sentimentAnalysis.neutral}
                                    </div>
                                    <div
                                      className={`text-sm ${theme === 'dark' ? 'text-white/60' : 'text-yellow-800'}`}
                                    >
                                      Neutral
                                    </div>
                                  </div>
                                  ...
                                  >
                                    ...
                                    <div
                                      className={`text-sm ${theme === 'dark' ? 'text-white/60' : 'text-red-800'}`}
                                    >
                                      Negative
                                    </div>
                                  </div>
